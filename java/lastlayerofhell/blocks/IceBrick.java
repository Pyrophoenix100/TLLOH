...
public class IceBrick extends Block {

	public IceBrick() {
		super(Material.ice);
		this.setBlockName("IceBrick");
		this.setCreativeTab(HellMod.tabCustom);
		this.setBlockTextureName(HellMod.modid + ":IceBrick");
	}
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        ...
        for (int l = 0; l < 4; ++l)
        {
            ...
            p_149734_1_.spawnParticle("dripWater", d0, d1, d2, d3, d4, d5);
        }
    }
