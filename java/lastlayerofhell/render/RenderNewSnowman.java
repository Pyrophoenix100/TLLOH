...
import lastlayerofhell.entities.ModelNewSnowman;
...
public class RenderNewSnowman extends RenderLiving{
	public static ResourceLocation texture = new ResourceLocation("kirbyandfriends" + ":" + "textures/entities/snowman.png");;  
